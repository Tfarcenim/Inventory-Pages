...
public class DropoffButton extends SmallButton {


    public DropoffButton(int x, int y, int widthIn, int heightIn, Component buttonText, OnPress callback, OnTooltip onTooltip) {
        super(x, y, widthIn, heightIn, buttonText, callback, onTooltip);
    }

    public DropoffButton(int x, int y, int widthIn, int heightIn, Component buttonText, OnPress callback) {
